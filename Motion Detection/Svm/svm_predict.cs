...
class svm_predict
{
    private static System.Windows.Forms.TextBox outputInfo;
	...
	private static void  predict(System.IO.StreamReader input, System.IO.BinaryWriter output, svm_model model, int predict_probability)
	{
        ...
        outputInfo.Text += "Accuracy = " + (double)correct / total * 100 + "% (" + correct + "/" + total + ") (classification)\n";
	}
    ...
    public svm_predict(System.String[] argv,System.Windows.Forms.TextBox info)
	{
        outputInfo = info;
